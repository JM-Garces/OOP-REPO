...
namespace HotelManagementSystem
{
    public partial class Login : Form
    {
        ...
        {
            InitializeComponent();
            this.Icon = new System.Drawing.Icon("Hotel Icon.ico");
        }
        ...
        private void button_login_Click(object sender, EventArgs e)
        {
            ...
            using (SQLiteConnection conn = new SQLiteConnection(connectionString))
            {
                ...
                {
                    label_username_required.Text = "*";
                    label_username_required.Visible = true;
                    isValid = false;
                }
                else
                {
                    label_username_required.Visible = false;
                }

                if (string.IsNullOrWhiteSpace(textBox_password.Text))
                {
                    label_password_required.Text = "*";
                    label_password_required.Visible = true;
                    isValid = false;
                }
                else
                {
                    label_password_required.Visible = false;
                }
                if (isValid)
                {
                    conn.Open();
