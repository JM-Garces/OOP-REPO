...
namespace HotelManagement
{
    public partial class StartUp : Form
    {
        ...
        {
            string connectionString = "Data Source=HotelDatabase.db;Version=3;";
            using (SQLiteConnection conn = new SQLiteConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT COUNT(1) FROM ACCOUNT WHERE AccountUsername=@username AND AccountPassword=@password";
